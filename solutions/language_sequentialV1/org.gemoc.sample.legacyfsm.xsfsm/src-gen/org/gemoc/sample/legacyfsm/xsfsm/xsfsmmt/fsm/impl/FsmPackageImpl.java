...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	...
	public void initializePackageContents() {
		...
		addEOperation(stateMachineEClass, null, "initializeModel", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		addEOperation(fsmSystemEClass, null, "main", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = addEOperation(fsmSystemEClass, null, "initialize", 0, 1, IS_UNIQUE, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (fsmSystemEClass.getEOperations().get(0), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (fsmSystemEClass.getEOperations().get(1), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
