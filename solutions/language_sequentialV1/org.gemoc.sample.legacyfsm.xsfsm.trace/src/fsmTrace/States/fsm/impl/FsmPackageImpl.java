...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	 ...
	 * @generated
	 */
	private EClass tracedFSMSystemEClass = null;
	 ...
	 * @generated
	 */
	public EClass getTracedFSMSystem() {
		return tracedFSMSystemEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTracedFSMSystem_OriginalObject() {
		return (EReference)tracedFSMSystemEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		tracedFSMSystemEClass = createEClass(TRACED_FSM_SYSTEM);
		createEReference(tracedFSMSystemEClass, TRACED_FSM_SYSTEM__ORIGINAL_OBJECT);
	...
	public void initializePackageContents() {
		...
		tracedBufferEClass.getESuperTypes().add(this.getTracedNamedElement());
		tracedFSMSystemEClass.getESuperTypes().add(this.getTracedNamedElement());
		...
		initEReference(getTracedBuffer_OriginalObject(), theFsmPackage_1.getBuffer(), null, "originalObject", null, 0, 1, TracedBuffer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tracedFSMSystemEClass, TracedFSMSystem.class, "TracedFSMSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTracedFSMSystem_OriginalObject(), theFsmPackage_1.getFSMSystem(), null, "originalObject", null, 0, 1, TracedFSMSystem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
