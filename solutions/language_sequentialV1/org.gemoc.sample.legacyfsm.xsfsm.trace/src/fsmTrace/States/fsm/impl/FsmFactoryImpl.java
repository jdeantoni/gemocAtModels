...
public class FsmFactoryImpl extends EFactoryImpl implements FsmFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FsmPackage.TRACED_BUFFER: return createTracedBuffer();
			case FsmPackage.TRACED_FSM_SYSTEM: return createTracedFSMSystem();
	 ...
	 * @generated
	 */
	public TracedBuffer createTracedBuffer() {
		TracedBufferImpl tracedBuffer = new TracedBufferImpl();
		return tracedBuffer;
	}
	 ...
	 * @generated
	 */
	public TracedFSMSystem createTracedFSMSystem() {
		TracedFSMSystemImpl tracedFSMSystem = new TracedFSMSystemImpl();
		return tracedFSMSystem;
	}
