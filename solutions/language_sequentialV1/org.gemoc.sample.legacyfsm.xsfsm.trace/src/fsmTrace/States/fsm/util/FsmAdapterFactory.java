...
public class FsmAdapterFactory extends AdapterFactoryImpl {
	...
	protected FsmSwitch<Adapter> modelSwitch =
		new FsmSwitch<Adapter>() {
			@Override
			public Adapter caseTracedBuffer(TracedBuffer object) {
				return createTracedBufferAdapter();
			}
			@Override
			public Adapter caseTracedFSMSystem(TracedFSMSystem object) {
				return createTracedFSMSystemAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.States.fsm.TracedBuffer <em>Traced Buffer</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedBufferAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.States.fsm.TracedFSMSystem <em>Traced FSM System</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedFSMSystemAdapter() {
		return null;
	}
