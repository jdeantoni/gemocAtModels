...
public interface FsmPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link fsmTrace.States.fsm.impl.TracedBufferImpl <em>Traced Buffer</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fsmTrace.States.fsm.impl.TracedBufferImpl
	 * @see fsmTrace.States.fsm.impl.FsmPackageImpl#getTracedBuffer()
	 * @generated
	 */
	int TRACED_BUFFER = 0;
	 ...
	 * @ordered
	 */
	int TRACED_BUFFER__CURRENT_VALUES_SEQUENCE = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int TRACED_BUFFER__ORIGINAL_OBJECT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int TRACED_BUFFER_FEATURE_COUNT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 2;

	/**
	 * The meta object id for the '{@link fsmTrace.States.fsm.impl.TracedFSMSystemImpl <em>Traced FSM System</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see fsmTrace.States.fsm.impl.TracedFSMSystemImpl
	 * @see fsmTrace.States.fsm.impl.FsmPackageImpl#getTracedFSMSystem()
	 * @generated
	 */
	int TRACED_FSM_SYSTEM = 1;
	 ...
	 * @ordered
	 */
	int TRACED_FSM_SYSTEM__ORIGINAL_OBJECT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>Traced FSM System</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRACED_FSM_SYSTEM_FEATURE_COUNT = TRACED_NAMED_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for class '{@link fsmTrace.States.fsm.TracedBuffer <em>Traced Buffer</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Traced Buffer</em>'.
	 * @see fsmTrace.States.fsm.TracedBuffer
	 * @generated
	 */
	EClass getTracedBuffer();

	/**
	 * Returns the meta object for the containment reference list '{@link fsmTrace.States.fsm.TracedBuffer#getCurrentValuesSequence <em>Current Values Sequence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link fsmTrace.States.fsm.TracedBuffer#getOriginalObject <em>Original Object</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Original Object</em>'.
	 * @see fsmTrace.States.fsm.TracedBuffer#getOriginalObject()
	 * @see #getTracedBuffer()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link fsmTrace.States.fsm.TracedFSMSystem <em>Traced FSM System</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Traced FSM System</em>'.
	 * @see fsmTrace.States.fsm.TracedFSMSystem
	 * @generated
	 */
	EClass getTracedFSMSystem();

	/**
	 * Returns the meta object for the reference '{@link fsmTrace.States.fsm.TracedFSMSystem#getOriginalObject <em>Original Object</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Original Object</em>'.
	 * @see fsmTrace.States.fsm.TracedFSMSystem#getOriginalObject()
	 * @see #getTracedFSMSystem()
	 * @generated
	 */
	EReference getTracedFSMSystem_OriginalObject();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link fsmTrace.States.fsm.impl.TracedBufferImpl <em>Traced Buffer</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fsmTrace.States.fsm.impl.TracedBufferImpl
		 * @see fsmTrace.States.fsm.impl.FsmPackageImpl#getTracedBuffer()
		...
		/**
		 * The meta object literal for the '{@link fsmTrace.States.fsm.impl.TracedFSMSystemImpl <em>Traced FSM System</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see fsmTrace.States.fsm.impl.TracedFSMSystemImpl
		 * @see fsmTrace.States.fsm.impl.FsmPackageImpl#getTracedFSMSystem()
		 * @generated
		 */
		EClass TRACED_FSM_SYSTEM = eINSTANCE.getTracedFSMSystem();
		 ...
		 * @generated
		 */
		EReference TRACED_FSM_SYSTEM__ORIGINAL_OBJECT = eINSTANCE.getTracedFSMSystem_OriginalObject();
