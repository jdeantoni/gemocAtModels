 ...
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.States.impl.Buffer_currentValues_ValueImpl#getStatesNoOpposite <em>States No Opposite</em>}</li>
 *   <li>{@link fsmTrace.States.impl.Buffer_currentValues_ValueImpl#getCurrentValues <em>Current Values</em>}</li>
 *   <li>{@link fsmTrace.States.impl.Buffer_currentValues_ValueImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link fsmTrace.States.impl.Buffer_currentValues_ValueImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Buffer_currentValues_ValueImpl extends MinimalEObjectImpl.Container implements Buffer_currentValues_Value {
	...
	public void setParent(TracedBuffer newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != StatesPackage.BUFFER_CURRENT_VALUES_VALUE__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, FsmPackage.TRACED_BUFFER__CURRENT_VALUES_SEQUENCE, TracedBuffer.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StatesPackage.BUFFER_CURRENT_VALUES_VALUE__PARENT:
				return eInternalContainer().eInverseRemove(this, FsmPackage.TRACED_BUFFER__CURRENT_VALUES_SEQUENCE, TracedBuffer.class, msgs);
		}
