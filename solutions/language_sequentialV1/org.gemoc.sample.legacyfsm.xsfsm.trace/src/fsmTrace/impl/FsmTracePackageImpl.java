...
public class FsmTracePackageImpl extends EPackageImpl implements FsmTracePackage {
	 ...
	 * @generated
	 */
	public EReference getSpecificTrace_Fsm_FSMSystem_Initialize_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getSpecificTrace_Fsm_StateMachine_Run_Sequence() {
	 ...
	 * @generated
	 */
	public EReference getSpecificTrace_Fsm_tracedBuffers() {
	 ...
	 * @generated
	 */
	public EReference getSpecificTrace_Fsm_tracedFSMSystems() {
	...
	public void createPackageContents() {
		...
		createEReference(specificTraceEClass, SPECIFIC_TRACE__FSM_FSM_SYSTEM_INITIALIZE_SEQUENCE);
		createEReference(specificTraceEClass, SPECIFIC_TRACE__FSM_STATE_MACHINE_RUN_SEQUENCE);
		...
		createEReference(specificTraceEClass, SPECIFIC_TRACE__FSM_TRACED_BUFFERS);
		createEReference(specificTraceEClass, SPECIFIC_TRACE__FSM_TRACED_FSM_SYSTEMS);
	...
	public void initializePackageContents() {
		...
		initEReference(getSpecificTrace_Fsm_FSMSystem_Initialize_Sequence(), theStepsPackage.getFsm_FSMSystem_Initialize(), null, "Fsm_FSMSystem_Initialize_Sequence", null, 0, -1, SpecificTrace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSpecificTrace_Fsm_StateMachine_Run_Sequence(), theStepsPackage.getFsm_StateMachine_Run(), null, "Fsm_StateMachine_Run_Sequence", null, 0, -1, SpecificTrace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSpecificTrace_Fsm_tracedBuffers(), theFsmPackage_1.getTracedBuffer(), null, "fsm_tracedBuffers", null, 0, -1, SpecificTrace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEReference(getSpecificTrace_Fsm_tracedFSMSystems(), theFsmPackage_1.getTracedFSMSystem(), null, "fsm_tracedFSMSystems", null, 0, -1, SpecificTrace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
