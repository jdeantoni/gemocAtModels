...
public class FSMSystemAdapter extends EObjectAdapter<FSMSystem> implements org.gemoc.sample.legacyfsm.fsm.FSMSystem {
  ...
  public EClass eClass() {
    return org.gemoc.sample.legacyfsm.fsm.FsmPackage.eINSTANCE.getFSMSystem();
  }
  
  @Override
  public Object eGet(final int featureID, final boolean resolve, final boolean coreType) {
    switch (featureID) {
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.FSM_SYSTEM__NAME:
    		return getName();
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.FSM_SYSTEM__OWNED_STATE_MACHINES:
    		return getOwnedStateMachines();
    	case org.gemoc.sample.legacyfsm.fsm.FsmPackage.FSM_SYSTEM__OWNED_BUFFER:
