...
public class StepsAdapterFactory extends AdapterFactoryImpl {
	...
	protected StepsSwitch<Adapter> modelSwitch =
		new StepsSwitch<Adapter>() {
			@Override
			public Adapter caseFsm_FSMSystem_Initialize(Fsm_FSMSystem_Initialize object) {
				return createFsm_FSMSystem_InitializeAdapter();
			}
			@Override
			public Adapter caseFsm_StateMachine_Run(Fsm_StateMachine_Run object) {
				return createFsm_StateMachine_RunAdapter();
			}
			@Override
			public Adapter caseFsm_StateMachine_Run_AbstractSubStep(Fsm_StateMachine_Run_AbstractSubStep object) {
				return createFsm_StateMachine_Run_AbstractSubStepAdapter();
			}
			@Override
			public Adapter caseFsm_StateMachine_Run_ImplicitStep(Fsm_StateMachine_Run_ImplicitStep object) {
				return createFsm_StateMachine_Run_ImplicitStepAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.Steps.Fsm_FSMSystem_Initialize <em>Fsm FSM System Initialize</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFsm_FSMSystem_InitializeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.Steps.Fsm_StateMachine_Run <em>Fsm State Machine Run</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFsm_StateMachine_RunAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.Steps.Fsm_StateMachine_Run_AbstractSubStep <em>Fsm State Machine Run Abstract Sub Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFsm_StateMachine_Run_AbstractSubStepAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.Steps.Fsm_StateMachine_Run_ImplicitStep <em>Fsm State Machine Run Implicit Step</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFsm_StateMachine_Run_ImplicitStepAdapter() {
		return null;
	}
