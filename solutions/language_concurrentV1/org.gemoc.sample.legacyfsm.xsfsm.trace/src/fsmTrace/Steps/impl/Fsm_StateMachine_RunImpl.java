...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fsm State Machine Run</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.Steps.impl.Fsm_StateMachine_RunImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link fsmTrace.Steps.impl.Fsm_StateMachine_RunImpl#getStartingState <em>Starting State</em>}</li>
 *   <li>{@link fsmTrace.Steps.impl.Fsm_StateMachine_RunImpl#getSubSteps <em>Sub Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Fsm_StateMachine_RunImpl extends StepImpl implements Fsm_StateMachine_Run {
	/**
	 ...
	 * @ordered
	 */
	protected EList<Fsm_StateMachine_Run_AbstractSubStep> subSteps;
	 ...
	 * @generated
	 */
	protected Fsm_StateMachine_RunImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.FSM_STATE_MACHINE_RUN;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.FSM_STATE_MACHINE_RUN__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_STATE_MACHINE_RUN__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_STATE_MACHINE_RUN__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.FSM_STATE_MACHINE_RUN__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_STATE_MACHINE_RUN__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_STATE_MACHINE_RUN__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public EList<Fsm_StateMachine_Run_AbstractSubStep> getSubSteps() {
		if (subSteps == null) {
			subSteps = new EObjectContainmentEList<Fsm_StateMachine_Run_AbstractSubStep>(Fsm_StateMachine_Run_AbstractSubStep.class, this, StepsPackage.FSM_STATE_MACHINE_RUN__SUB_STEPS);
		}
		return subSteps;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.FSM_STATE_MACHINE_RUN__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.FSM_STATE_MACHINE_RUN__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case StepsPackage.FSM_STATE_MACHINE_RUN__SUB_STEPS:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case StepsPackage.FSM_STATE_MACHINE_RUN__SUB_STEPS:
				getSubSteps().clear();
				getSubSteps().addAll((Collection<? extends Fsm_StateMachine_Run_AbstractSubStep>)newValue);
				return;
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (derivedFeatureID) {
				case StepsPackage.FSM_STATE_MACHINE_RUN__SUB_STEPS: return TracePackage.BIG_STEP__SUB_STEPS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == BigStep.class) {
			switch (baseFeatureID) {
				case TracePackage.BIG_STEP__SUB_STEPS: return StepsPackage.FSM_STATE_MACHINE_RUN__SUB_STEPS;
				default: return -1;
			}
		}
		if (baseClass == SequentialStep.class) {
