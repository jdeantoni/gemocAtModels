...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fsm FSM System Initialize</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fsmTrace.Steps.impl.Fsm_FSMSystem_InitializeImpl#getEndingState <em>Ending State</em>}</li>
 *   <li>{@link fsmTrace.Steps.impl.Fsm_FSMSystem_InitializeImpl#getStartingState <em>Starting State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Fsm_FSMSystem_InitializeImpl extends StepImpl implements Fsm_FSMSystem_Initialize {
	/**
	 ...
	 * @generated
	 */
	protected Fsm_FSMSystem_InitializeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StepsPackage.Literals.FSM_FSM_SYSTEM_INITIALIZE;
	}
		...
		if (endingState != null && endingState.eIsProxy()) {
			...
			if (endingState != oldEndingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__ENDING_STATE, oldEndingState, endingState));
			}
		}
		return endingState;
	}
	...
	public NotificationChain basicSetEndingState(State newEndingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__ENDING_STATE, oldEndingState, newEndingState);
	...
	public void setEndingState(State newEndingState) {
		if (newEndingState != endingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__ENDING_STATE, newEndingState, newEndingState));
	}
	...
	public State getStartingState() {
		if (startingState != null && startingState.eIsProxy()) {
			...
			if (startingState != oldStartingState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__STARTING_STATE, oldStartingState, startingState));
			}
		}
	...
	public NotificationChain basicSetStartingState(State newStartingState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__STARTING_STATE, oldStartingState, newStartingState);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setStartingState(State newStartingState) {
		if (newStartingState != startingState) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__STARTING_STATE, newStartingState, newStartingState));
	}
	 ...
	 * @generated
	 */
	public TracedFSMSystem getCaller() {
		return (fsmTrace.States.fsm.TracedFSMSystem) this.getMseoccurrence().getMse().getCaller();
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__ENDING_STATE:
				if (endingState != null)
					msgs = ((InternalEObject)endingState).eInverseRemove(this, StatesPackage.STATE__ENDED_STEPS, State.class, msgs);
				return basicSetEndingState((State)otherEnd, msgs);
			case StepsPackage.FSM_FSM_SYSTEM_INITIALIZE__STARTING_STATE:
				if (startingState != null)
					msgs = ((InternalEObject)startingState).eInverseRemove(this, StatesPackage.STATE__STARTED_STEPS, State.class, msgs);
