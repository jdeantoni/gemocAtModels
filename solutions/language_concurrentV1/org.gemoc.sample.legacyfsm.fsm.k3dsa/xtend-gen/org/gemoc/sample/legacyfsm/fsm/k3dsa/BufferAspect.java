...
public class BufferAspect {
  public static void initialize(final Buffer _self) {
    final org.gemoc.sample.legacyfsm.fsm.k3dsa.BufferAspectBufferAspectProperties _self_ = org.gemoc.sample.legacyfsm.fsm.k3dsa.BufferAspectBufferAspectContext.getSelf(_self);
  ...
  public static EList<String> currentValues(final Buffer _self) {
    ...
    return (org.eclipse.emf.common.util.EList<java.lang.String>)result;
  }
